...
class Analog4Kit extends Struct {
    ...
    public function getDataMap(): array {
        return [
            ...
            'cv_env1_dst1' => new Int8_2(Analog4Dest::CV_ENV1),
            'cv_env1_dst2' => new Int8_2(Analog4Dest::CV_ENV1),
            'cv_env2_dst1' => new Int8_2(Analog4Dest::CV_ENV2),
            'cv_env2_dst2' => new Int8_2(Analog4Dest::CV_ENV2),
